...
pub fn read_weapon_data() -> Result<WexpData, Error> {
    let config_default = File::open("sd:/engage/config/WpnExp/default/wexp_data.json").ok();
    let mut file = match config_default {
        Some(file) => file,
        None => {
            println!("No config wexp_data file found, using default.");
            File::open("sd:/engage/mods/WpnExp/default/wexp_data.json")
                .expect("JSON file could not be opened.")
        },
    };
...
pub fn read_default_unit_data() -> Result<UnitWexpData, Error> {
    let config_default = File::open("sd:/engage/config/WpnExp/default/unit_wexp_data.json").ok();
    let mut file = match config_default {
        Some(file) => file,
        None => {
            println!("No config unit_wexp_data file found, using default.");
            File::open("sd:/engage/mods/WpnExp/default/default_unit_wexp_data.json")
                .expect("Default static JSON file could not be opened.")
        },
    };
...
pub fn read_default_dyn_unit_data() -> Result<UnitWexpData, Error> {
    let config_default = File::open("sd:/engage/config/WpnExp/default/dyn_unit_wexp_data.json").ok();
    let mut file = match config_default {
        Some(file) => file,
        None => {
            println!("No config dyn_unit_wexp_data file found, using default.");
            File::open("sd:/engage/mods/WpnExp/default/default_dyn_unit_wexp_data.json")
                .expect("Default dynamic JSON file could not be opened.")
        },
    };
...
pub fn read_unit_data(save_slot: i32) -> Result<UnitWexpData, Error> {
    let path = String::from("sd:/engage/config/WpnExp/save/") + &save_slot.to_string() + "/unit_wexp_data.json";
...
pub fn copy_unit_data(dst_save_slot: i32, src_save_slot: i32) -> Result<(), Box<dyn std::error::Error>> {
    let src_path = String::from("sd:/engage/config/WpnExp/save/") + &src_save_slot.to_string() + "/unit_wexp_data.json";
    let dst_path = String::from("sd:/engage/config/WpnExp/save/") + &dst_save_slot.to_string() + "/unit_wexp_data.json";
...
pub fn read_dynamic_unit_data(save_slot: i32) -> Result<UnitWexpData, Error> {
    let path = String::from("sd:/engage/config/WpnExp/save/") + &save_slot.to_string() + "/dyn_unit_wexp_data.json";
...
pub fn copy_dynamic_unit_data(dst_save_slot: i32, src_save_slot: i32) -> Result<(), Box<dyn std::error::Error>> {
    let src_path = String::from("sd:/engage/config/WpnExp/save/") + &src_save_slot.to_string() + "/dyn_unit_wexp_data.json";
    let dst_path = String::from("sd:/engage/config/WpnExp/save/") + &dst_save_slot.to_string() + "/dyn_unit_wexp_data.json";
...
pub fn read_ledger_unit_data(save_slot: i32) -> Result<WexpRewindLedger, Error> {
    let path = String::from("sd:/engage/config/WpnExp/save/") + &save_slot.to_string() + "/rewind_ledger.json";
...
pub fn copy_ledger_unit_data(dst_save_slot: i32, src_save_slot: i32) -> Result<(), Box<dyn std::error::Error>> {
    let src_path = String::from("sd:/engage/config/WpnExp/save/") + &src_save_slot.to_string() + "/rewind_ledger.json";
    let dst_path = String::from("sd:/engage/config/WpnExp/save/") + &dst_save_slot.to_string() + "/rewind_ledger.json";
...
pub fn get_unit_wexp(unit: Unit, kind: ItemData_Kinds) -> i32 {
    if unit.is_null() || unit.m_aptitude().is_null() || unit.m_original_aptitude().is_null() {
        return 0
    }
...
pub fn get_god_wexp(god: GodUnit, kind: ItemData_Kinds) -> i32 {
    if god.is_null() || god.m_data().is_null() {
        return 0
    }
